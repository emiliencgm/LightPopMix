...
def parse_args():
    ...
    parser.add_argument('--loss', type=str, default='Adaptive', help="loss function: BPR, BPR_Contrast, BC, Adaptive, PDA, DCL")
    parser.add_argument('--augment', type=str, default='No', help="Augmentation: No, ED, RW, SVD")    
